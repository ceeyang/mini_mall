...
export function renderNavbar(currentPage = 'index') {
  ...
  const userMenuHTML = isAuthenticated ? `
    <div class="relative group">
      ...
      <div id="user-dropdown" class="hidden absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-lg border border-gray-200 py-2 z-50">
        <a href="/user-center" class="block px-4 py-2 text-gray-700 hover:bg-indigo-50 hover:text-indigo-600 transition-colors duration-200 cursor-pointer">我的订单</a>
        <a href="/user-center" class="block px-4 py-2 text-gray-700 hover:bg-indigo-50 hover:text-indigo-600 transition-colors duration-200 cursor-pointer">账户设置</a>
  ...
  ` : `
    <a href="/login" class="px-4 py-2 text-gray-700 hover:text-indigo-600 transition-colors duration-200 cursor-pointer font-medium">
      登录
    </a>
  `;
      ...
      <div class="bg-white/90 backdrop-blur-md rounded-2xl shadow-lg border border-gray-200 px-4 md:px-6 py-4">
        <div class="flex items-center justify-between">
          ...
          <div class="hidden md:flex items-center space-x-6">
            ...
            <a href="/products" class="text-gray-700 hover:text-indigo-600 transition-colors duration-200 cursor-pointer">商品</a>
            <a href="/about" class="text-gray-700 hover:text-indigo-600 transition-colors duration-200 cursor-pointer">关于</a>
            <a href="/contact" class="text-gray-700 hover:text-indigo-600 transition-colors duration-200 cursor-pointer">联系</a>
          </div>
          ...
          <div class="flex items-center space-x-3">
            ...
            <!-- 购物车按钮 -->
            <a href="/cart" id="cart-button" class="bg-indigo-600 text-white px-4 md:px-6 py-2 rounded-lg hover:bg-indigo-700 transition-colors duration-200 cursor-pointer font-medium flex items-center">
        ...
        <div id="mobile-menu" class="hidden md:hidden mt-4 pt-4 border-t border-gray-200">
          <div class="flex flex-col space-y-3">
            ...
            <a href="/products" class="mobile-menu-link text-gray-700 hover:text-indigo-600 hover:bg-indigo-50 px-4 py-2 rounded-lg transition-colors duration-200 cursor-pointer">商品</a>
            <a href="/about" class="mobile-menu-link text-gray-700 hover:text-indigo-600 hover:bg-indigo-50 px-4 py-2 rounded-lg transition-colors duration-200 cursor-pointer">关于</a>
            <a href="/contact" class="mobile-menu-link text-gray-700 hover:text-indigo-600 hover:bg-indigo-50 px-4 py-2 rounded-lg transition-colors duration-200 cursor-pointer">联系</a>
            ${isAuthenticated ? `
              <a href="/user-center" class="mobile-menu-link text-gray-700 hover:text-indigo-600 hover:bg-indigo-50 px-4 py-2 rounded-lg transition-colors duration-200 cursor-pointer">我的订单</a>
            ...
            ` : `
              <a href="/login" class="mobile-menu-link text-gray-700 hover:text-indigo-600 hover:bg-indigo-50 px-4 py-2 rounded-lg transition-colors duration-200 cursor-pointer">登录</a>
            `}
          </div>
        </div>
      </div>
